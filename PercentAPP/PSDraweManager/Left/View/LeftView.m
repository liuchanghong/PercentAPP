...
#define kBackgroundColor HexRGB(0xefe7d8)
...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        self.dataArray = @[@[[UIImage imageNamed:@"copy"], @"我的商城"],
                           @[[UIImage imageNamed:@"copy"], @"QQ钱包"],
                           @[[UIImage imageNamed:@"copy"], @"个性装扮"],
                           @[[UIImage imageNamed:@"copy"], @"我的收藏"],
                           @[[UIImage imageNamed:@"copy"], @"我的相册"],
                           @[[UIImage imageNamed:@"copy"], @"我的文件"]];
